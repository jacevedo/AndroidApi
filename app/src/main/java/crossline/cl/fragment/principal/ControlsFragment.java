...
import crossline.cl.portafolio.ControlsActivity;
...
public class ControlsFragment extends Fragment implements OnItemClickListener
{
    ...
    private void initComponents(View v)
    {
        ...
        RecicleViewAdapterBlack adapter = new RecicleViewAdapterBlack(((BaseFragmentActivity)getActivity()).getControlsList());
    ...
    {
        Intent i = new Intent(getActivity(), ControlsActivity.class);
