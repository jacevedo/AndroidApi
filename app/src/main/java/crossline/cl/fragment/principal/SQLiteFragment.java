...
public class SQLiteFragment extends Fragment implements OnItemClickListener
{
    ...
    private void initComponents(View v)
    {
        ...
        RecicleViewAdapterBlack adapter = new RecicleViewAdapterBlack(((BaseFragmentActivity)getActivity()).getSQLiteList());
    ...
    {
        Intent i = new Intent(getActivity(), SQLiteActivity.class);
        i.putExtra("typeDB", position);
        startActivity(i);
    }
}
