...
public class ViewHolderBlack extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ...
    public ViewHolderBlack(TextView v, OnItemClickListener clickListener)
    {
        super(v);
